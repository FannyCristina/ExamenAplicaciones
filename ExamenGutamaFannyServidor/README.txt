...
a persistence unit "ExamenGutamaFannyServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenGutamaFannyServidor\pom.xml":
...
artifact ("ExamenGutamaFannyServidor.war") is already built. You can build
